 ...
 * ML pipeline  to solve Santander Bank satisfaction problem
 * spark 2.0
 */
object SantanderRandomForestClassifier {

  def main(args: Array[String]): Unit = {
    val spark = SparkSession.builder.master("local[8]").appName("Santander Bank").getOrCreate()
    ...
    val rawData = spark.read.option("header", "true").option("inferSchema", "true").csv("/Users/jshetty/Documents/kaggle/santander/dataset/train.csv")
    ...
    // Save model
    cvModel.save("/Users/jshetty/Documents/kaggle/santander/model/mlpipeline/rf")
    ...
    // For submission
    val rawTest = spark.read.option("header", "true").option("inferSchema", "true").load("/Users/jshetty/Documents/kaggle/santander/dataset/test.csv")
    ...
    finaldf.rdd.saveAsTextFile("/Users/jshetty/Documents/kaggle/santander/submission/rf")
